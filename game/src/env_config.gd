...
const KNOWN := {
	...
	"WORLD_MODE": "creative | battle | ctf | holdout — the mode a room starts in (see GameModes)",
	...
	"WORLD_WARP": "how far the terrain lattice bends in tests/terrain_look (0 draws it flat)",
	"WORLD_WARP_SCENE": "wall for a sheer face in tests/terrain_look, otherwise a hillside",
	"WORLD_WARP_THEME": "which world tests/terrain_look photographs",
